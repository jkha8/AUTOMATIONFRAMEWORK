...
describe('The Home Page', () => {
  ...
  it('successfully loads', () => {
    ...
    cy.visit("https://tic88.com")
    cy.wait(2500)
    cy.get('.icon-close').click()
    cy.get('.focus\\:\\!bg-\\[none\\]').click()
    const brand = 'tic88';

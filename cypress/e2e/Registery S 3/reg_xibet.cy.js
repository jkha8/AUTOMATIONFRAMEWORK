...
describe('The Home Page', () => {
  ...
  it('successfully loads', () => {
    ...
    cy.visit("https://xibet.com")
    cy.get('.buttons > .fill > .base-button--content').click()
    const brand = 'xibet';
    ...
    cy.get(':nth-child(2) > .base-input__wrap > .base-input__wrap-input > .imask').type(password)
    cy.get(':nth-child(3) > .base-input__wrap > .base-input__wrap-input > .imask').type(password)
    cy.get(':nth-child(4) > .base-input__wrap > .base-input__wrap-input > .imask').type(phoneNumber)
    cy.wait(1500)
    cy.get('div.w-100 > .btn > .base-button--content').contains("Đăng ký").click();

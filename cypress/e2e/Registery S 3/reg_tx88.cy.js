...
describe('The Home Page', () => {
  ...
  it('successfully loads', () => {
    ...
    cy.get('.register-form > :nth-child(1) > .base-input > .base-input__wrap > input').type(randomStringAccount)
    cy.get('.register-form > :nth-child(2) > .base-input > .base-input__wrap > input').type(password)
    cy.get(':nth-child(3) > .base-input > .base-input__wrap > input').type(phoneNumber)
    cy.wait(1500)
    cy.get('.register-form').contains("Đăng ký").click();

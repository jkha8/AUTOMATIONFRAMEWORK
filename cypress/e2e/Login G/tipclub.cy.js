...
describe('Đăng nhập tự động vào web', () => {
    it('Đăng nhập vào web daily', () => {
        ...
        cy.visit('https://play.tipclub.win');
        cy.wait(7000);
        cy.get('#GameCanvas').click(420, 630, {force: true});
        //cy.wait(500);
